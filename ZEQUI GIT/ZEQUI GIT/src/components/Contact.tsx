...
import { Instagram, MapPin, Clock, Phone, Mail, Music2 } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <p className="text-white/40 text-sm mt-1">Síguenos en Instagram</p>
          </motion.a>
          ...
          {data.tiktokUrl && (
            <motion.a
              ...
              className="group bg-white/[0.03] border border-white/10 rounded-2xl p-6 hover:border-[#8B0000]/50 transition-all duration-300 hover:bg-[#8B0000]/5"
            >
              <Music2 className="text-[#8B0000] mb-4" size={28} />
              <p className="text-white font-bold text-lg">{data.tiktokHandle}</p>
              <p className="text-white/40 text-sm mt-1">Síguenos en TikTok</p>
            </motion.a>
          )}
